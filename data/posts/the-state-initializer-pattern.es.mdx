...
Photo by [Silvio Kundt](https://unsplash.com/photos/Fixg8KipOg8)
...
componentes a su original estado sin tener que desmontar y montar completamente el componente.
...
> del `input` elemento. Aunque esto tiene sentido, yo todavía prefiero el pre
...
Y aquí esta con un contador inicial igual a `8`:
...
del nombre de la propiedad? Aquí esta un ejemplo donde el consumidor de nuestro contador
...
> recomiendo que le des una rápida lectura antes te continuar.
...
Y aquí esta rendereado:

<div className="demo">
  <KeyPropReset initialCount={10} />
</div>

Te habrás dado cuenta que tuvimos que reestructurar un poco el código para lograr esto. En algunas
situaciones esto pueder no ser posible o deseable.

Adicionalmente, desmontar y montar el componente nuevamente (que es lo que la `key` propiedad hará) tiene más
...
gente me preguntaba por questiones que este resuelve, por lo que decidí añadirlo. Espero que este artículo the ayude con tu trabajo. Buena suerte!!
