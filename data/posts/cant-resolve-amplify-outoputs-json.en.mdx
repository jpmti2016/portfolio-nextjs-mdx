...
<Notice className="">
  <p>
    Take into account the less privilege principle, that policy could be too
...
For example, in a (build configuration)[https://docs.aws.amazon.com/code-library/latest/ug/cli_2_codepipeline_code_examples.html] it might look like: [2]
