...
The `amplify_outputs.json` file is generated in your [Amplify Gen 2] project by the CLI. It contains the your backend information needed to configure the client libraries that interact with your backend resources like Auhtentication,
Data, Storage, Lambda functions, AI, etc.
