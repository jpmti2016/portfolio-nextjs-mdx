...
The `amplify_outputs.json` file is generated in your [Amplify Gen 2](https://docs.amplify.aws/react/reference/amplify_outputs/) project by the CLI. It contains the your backend information needed to configure the client libraries that
interact with your backend resources like Auhtentication, Data, Storage, Lambda functions, AI, etc.

Its content is very sensitive, must not be commited to your repository and instead generated at deployment time by your build command.
