...
If you are getting into the world of Web3, DeFi and blockchain, then you probably know already that Rust is used to code with Solana and Polkadot. You can do a lot with [high level libraries in Solana with your language of choice but at some point you may need to create your custom smart contracts and for that you have Rust](https://solana.com/news/getting-started-with-solana-development).
