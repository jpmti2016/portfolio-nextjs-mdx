          ...
          <div className="flex mb-3 space-x-2 text-2xl sm:text-3xl sm:space-x-4">
            ...
            >
              <svg
                ...
                className="w-full h-full rounded-full fill-current dark:text-gray-200 sm:h-10 sm:w-10 hover:ring-gray-600 hover:bg-gray-600 hover:text-gray-200 dark:hover:text-gray-900"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 999.937 999.937"
              >
                <path
                  className="w-full fill-current dark:text-gray-200"
